  ...
  return (
    <>
      <video
        ...
        loop
        muted
        className="absolute left-1/2 top-1/2 z-0 h-full w-full -translate-x-1/2 -translate-y-1/2 transform object-cover brightness-50 filter"
      >
        <source src="/reading.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div className="relative mx-auto flex  h-[80vh] w-full max-w-7xl items-center px-10">
        <div className="">
          <h1 className="z-10 text-6xl font-bold dark:text-white md:text-7xl">
            Blog
          </h1>
          <p className="z-10 mx-auto mt-8 max-w-2xl text-xl dark:text-neutral-200 md:text-3xl">
            A place to talk about software engineer, covering coding techniques,
            problem-solving approaches, and industry trends.
          </p>
        </div>
      </div>
...
export default function Index() {
  ...
  return (
    <main>
      ...
      */}
      <Hero />
      <div className="grid grid-cols-1 gap-4 p-2 lg:grid-cols-2 2xl:grid-cols-3">
        {/*
        <ThreeDCard  
